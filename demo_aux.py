...
envs = [
    "17DRP5sb8fy_0", "VLzqgDo317F_1", "pRbA3pwrgk9_1", "D7N2EKCX4Sj_0", "i5noydFURQK_0", "pa4otMbVnkk_1", "X7HyMhZNoso_0", "gTV8FGcVJC9_2", "pRbA3pwrgk9_3", "VzqfbhrpDEA_1", "gTV8FGcVJC9_1", "ARNzJeq3xxb_0"
]
...
for env in tqdm(envs):
    ...
    with torch.no_grad():
        ...
        cv2.imwrite("map_viz/output_aux{}.png".format(env), semmap_color)
